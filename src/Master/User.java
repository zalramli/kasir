...
public class User extends javax.swing.JInternalFrame {
    ...
    private void tampil_data(){
        ...
        try {
            ...
            java.sql.ResultSet res=stm.executeQuery(sql);
            while(res.next()){
                model.addRow(new Object[]{res.getString(2),res.getString(3),res.getString(4),res.getString(5),res.getString(6),res.getString(1)});
            }
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        ...
        String password = String.valueOf(txt_password.getPassword());
        try {
            String sql ="UPDATE user SET id_akses = '"+akses+"',nm_user = '"+txt_nama.getText()+"',username = '"+txt_username.getText()+"',password = '"+password+"' WHERE id_user = '"+txt_kode.getText()+"'";
            java.sql.Connection conn=(com.mysql.jdbc.Connection)Koneksi.configDB();
            java.sql.PreparedStatement pst=conn.prepareStatement(sql);
            pst.execute();
